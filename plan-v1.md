...
| [docs/architecture.md](docs/architecture.md)   | Code map, data flows, rules, and recipes for common changes                               |
...
- [x] ~~**M6-6** Local error log~~ moved to M1a-12
...
| Foundation (2026-09-24 audit)  | Typed IPC via tauri-specta, exact-pinned (ADR 011); typed settings; logging and a global error handler moved from M6 to M1a; PR and issue templates; `pnpm verify`; docs/architecture.md with recipes | 42 stringly-typed commands, 7 hand-mirrored types, 68 string errors, settings over 11 files, no log file. Each would tax every feature                                |
