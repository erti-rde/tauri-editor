...
>
	...
	{:then matches}
		...
		{#if !includeLibrary}
			<button
				class="border-line-strong hover:bg-surface-hover m-4 rounded-md border px-3 py-2 text-sm"
		...
		{:else}
			<button
				class="text-ink-muted hover:bg-surface-hover m-4 rounded-md px-3 py-2 text-sm"
